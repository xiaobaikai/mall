<template>
    <section>
        ...
        <div class="content">
            ...
            <div class="styles input_group">
                <router-link :to="{ path:'/option', query: {indexs:isLegalHoliday,type:'overtime',color:'#f80'}}"  class="bor_bottom choose" tag="div">
...
let save_leave = (index,text,that) =>{
    if(that.beginTime == '请选择开始时间'){
        ...
        that.$toast('请选择结束时间')
    }else if(that.isLegalHoliday!='请选择'){
            ...
            if(this.$route.query.mealId){
                    this.axios.get('/work/overtime/info',{
                        params:{
                            ...
                            overTimeApplyId:this.$route.query.mealId
                        }
                    }).then(function(res){ 
                        let data = res.data.b;
