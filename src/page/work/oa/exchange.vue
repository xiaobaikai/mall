<template>
    <section>
        ...
        <div class="styles input_group">
                 <router-link tag="div" :to="{path:'/addressList',query:{bgcolor:'#609df6',peArrIndex:index,back:true}}" class="bor_bottom choose">
            ...
            <div class="styles input_group">
                ...
                <div class="bor_bottom">
                    ...
                    <textarea v-model.trim="mealStandard" name="" maxlength="1000" id="" cols="30" rows="10" placeholder="请输入加班原因,限定1000字">
...
let save_leave = (index,text,that) =>{
    if(that.mealTitle== ''){
        that.$toast('文件标题不能为空')
    }else if(that.mealTitle.length>30 ||that.mealTitle.length<6){
        ...
        // let contDesc = that.mealStandard.replace(/\n|\r\n/g,"<br>")
