    ...
    export default {
        ...
        ...mapMutations(['change_man','approver_man']),
            ...
            consent:function(){ //同意
               ...
               this.$router.push({path:'/opinion',query:{id:this.dataObj.tripId,receiverIds:copyStr,auditerIds:apprStr,color:'#609df6',typeName:'trip',applyType:4,pageType:'consent'}})
            },
            moreBtn(){
                this.isShow = true;
		        this.$forceUpdate();
        ...
        mounted:function(){
            ...
            this.axios.get('/work/trip/info?tripId='+this.tripId+'&pushId='+pusthId).then(function(res){
