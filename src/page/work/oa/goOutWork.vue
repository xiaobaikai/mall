    ...
    <section>
        ...
        <div class="content">
            ...
            <div class="styles input_group">
                ...
                <router-link tag="div" :to="{path:'/addressList',query:{bgcolor:'#0fc37c',peArrIndex:0}}" class="items">
                    同行人员
                    <p >
...
let save_leave = (index,text,that) =>{
    ...
    else if(that.outSideReason.length<6||that.outSideReason.length>30){
        that.$toast('公出事由内容不能低于6个或超过30个字符')
